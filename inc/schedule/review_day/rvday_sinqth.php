...
$res=mysqli_query($conn,"SELECT op.e_mat,op.pac_id,op.op_date,op.cant_horas,"
				...
				." WHERE op.op_date between '".$date." 00:00:00' and '".$date." 23:59:59' and op.op_sit='0' ORDER BY pac.pac_apellido") or die(mysqli_error($conn));

echo "<table class=myTable-gray width=100%>";
		 
	echo "<tr><td colspan=6 class=titulo>CUIDADOR SIN MARCAR QTH</td></tr>";
