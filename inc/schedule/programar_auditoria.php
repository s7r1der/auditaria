...
$res=mysqli_query($conn,"SELECT aud.aud_movilidad,aud.aud_conciencia,aud.aud_esfinteres,aud.aud_ingesta,aud.aud_heridas,aud.aud_contencion,aud.aud_zonaroja,"
						...
						."date_format(date_beg,\"%d/%m/%Y\") as fecha,date_format(date_beg,\"%Y-%m-%d\") as fecha1,date_format(date_beg,\"%h:%i\") as hora,"
...
while($row=mysqli_fetch_array($res,MYSQLI_ASSOC)){
	...
	echo "<table class=menu-gray align=center>";
		...
		echo "<tr valign=top>";
			...
			echo "<td>";	
				echo "<table class=myTable-gray width=100%>";
					...
					echo "<input type=hidden name=fecha value=\"".$row["fecha1"]."\">";
		...
		echo "<tr>";
			echo "<td colspan=6 align=center class=subtitulo><input type=submit name=event value=\"PROGRAMAR DOMICILIO\">";
		echo "</tr>";	
